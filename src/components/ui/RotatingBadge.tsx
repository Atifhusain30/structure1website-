    ...
    >
      ...
      <div className="absolute inset-0 rotating-badge">
        ...
        >
          ...
          <text className="fill-[#0D0D0D] text-[10px] font-medium tracking-[0.15em] uppercase">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-16 h-16 bg-rich-black rounded-full flex items-center justify-center shadow-lg">
